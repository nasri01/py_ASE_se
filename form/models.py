...
class monitor_spo2_1(models.Model):
    ...
    s1_e1_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_spo2,on_delete=models.PROTECT, related_name='ms1s1e1comment',default=1)
    s1_e2_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_spo2,on_delete=models.PROTECT, related_name='ms11s1e2comment',default=1)
    ...
    s4_e1_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_spo2,on_delete=models.PROTECT, related_name='ms1s4e1comment',default=1)
...
class monitor_ecg_1(models.Model):
    ...
    s1_e1_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s1e1comment',default=1)
    s1_e2_hr = models.IntegerField()
    s1_e2_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s1e2comment',default=1)
    s1_e3_hr = models.IntegerField()
    s1_e3_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s1e3comment',default=1)
    s1_e4_hr = models.IntegerField()
    s1_e4_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s1e4comment',default=1)
    s1_e5_hr = models.IntegerField()
    s1_e5_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s1e5comment',default=1)
    s1_e6_hr = models.IntegerField()
    s1_e6_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s1e6comment',default=1)
    s1_e7_hr = models.IntegerField()
    s1_e7_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s1e7comment',default=1)
    s1_e8_hr = models.IntegerField()
    s1_e8_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s1e8comment',default=1)

    s2_e1_hr = models.IntegerField()
    s2_e1_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s2e1comment',default=1)
    s2_e2_hr = models.IntegerField()
    s2_e2_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s2e2comment',default=1)
    s2_e3_hr = models.IntegerField()
    s2_e3_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s2e3comment',default=1)
    s2_e4_hr = models.IntegerField()
    s2_e4_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s2e4comment',default=1)
    s2_e5_hr = models.IntegerField()
    s2_e5_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s2e5comment',default=1)
    s2_e6_hr = models.IntegerField()
    s2_e6_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s2e6comment',default=1)
    s2_e7_hr = models.IntegerField()
    s2_e7_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s2e7comment',default=1)
    s2_e8_hr = models.IntegerField()
    s2_e8_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s2e8comment',default=1)
    s2_e9_hr = models.IntegerField()
    s2_e9_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s2e9comment',default=1)
    s2_e10_hr = models.IntegerField()
    s2_e10_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s2e10comment',default=1)

    s3_e1_hr = models.IntegerField()
    s3_e1_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s3e1comment',default=1)
    s3_e2_hr = models.IntegerField()
    s3_e2_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s3e2comment',default=1)
    s3_e3_hr = models.IntegerField()
    s3_e3_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s3e3comment',default=1)
    s3_e4_hr = models.IntegerField()
    s3_e4_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s3e4comment',default=1)
    s3_e5_hr = models.IntegerField()
    s3_e5_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s3e5comment',default=1)
    s3_e6_hr = models.IntegerField()
    s3_e6_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s3e6comment',default=1)
    s3_e7_hr = models.IntegerField()
    s3_e7_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s3e7comment',default=1)
    s3_e8_hr = models.IntegerField()
    s3_e8_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s3e8comment',default=1)
    s3_e9_hr = models.IntegerField()
    s3_e9_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s3e9comment',default=1)
    s3_e10_hr = models.IntegerField()
    s3_e10_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s3e10comment',default=1)
    ...
    s4_e1_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s4e1comment',default=1)


    s5_e1_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s5e1comment',default=1)
    s5_e2_delay = models.FloatField()
    s5_e2_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s5e2comment',default=1)
    s5_e3_delay = models.FloatField()
    s5_e3_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s5e3comment',default=1)
    s5_e4_delay = models.FloatField()
    s5_e4_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s5e4comment',default=1)

    s6_e1_damp = models.FloatField()
    s6_e1_ramp = models.FloatField(null=True,blank=True)
    s6_e1_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s6e1comment',default=1)
    s6_e2_damp = models.FloatField()
    s6_e2_ramp = models.FloatField(null=True,blank=True)
    s6_e2_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s6e2comment',default=1)
    s6_e3_damp = models.FloatField()
    s6_e3_ramp = models.FloatField(null=True,blank=True)
    s6_e3_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s6e3comment',default=1)

    s7_e1_damp = models.FloatField()
    s7_e1_ramp = models.FloatField(null=True,blank=True)
    s7_e1_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s7e1comment',default=1)
    s7_e2_damp = models.FloatField()
    s7_e2_ramp = models.FloatField(null=True,blank=True)
    s7_e2_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s7e2comment',default=1)
    s7_e3_damp = models.FloatField()
    s7_e3_ramp = models.FloatField(null=True,blank=True)
    s7_e3_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s7e3comment',default=1)
    s7_e4_damp = models.FloatField()
    s7_e4_ramp = models.FloatField(null=True,blank=True)
    s7_e4_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s7e4comment',default=1)
    s7_e5_damp = models.FloatField()
    s7_e5_ramp = models.FloatField(null=True,blank=True)
    s7_e5_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s7e5comment',default=1)

    s8_e1_bdisp = models.FloatField()
    s8_e1_slope = models.FloatField()
    s8_e1_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s8e1comment',default=1)

    s9_e1_comment = models.ForeignKey(acc.models.quantitive_comment_monitor_ecg,on_delete=models.PROTECT, related_name='me1s9e1comment',default=1)
...
class aed_1(models.Model):
    ...
    s2_e1_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s2e1comment',default=1)
    s2_e2_lc = models.IntegerField()
    s2_e2_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s2e2comment',default=1)
    s2_e3_lc = models.IntegerField()
    s2_e3_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s2e3comment',default=1)
    s2_e4_lc = models.IntegerField()
    s2_e4_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s2e4comment',default=1)
    s2_e5_lc = models.IntegerField()
    s2_e5_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s2e5comment',default=1)
    s2_e6_lc = models.IntegerField()
    s2_e6_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s2e6comment',default=1)
    s2_e7_lc = models.IntegerField()
    s2_e7_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s2e7comment',default=1)

    s3_e1_lc = models.IntegerField()
    s3_e1_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s3e1comment',default=1)
    s3_e2_lc = models.IntegerField()
    s3_e2_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s3e2comment',default=1)
    s3_e3_lc = models.IntegerField()
    s3_e3_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s3e3comment',default=1)
    s3_e4_lc = models.IntegerField()
    s3_e4_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s3e4comment',default=1)
    s3_e5_lc = models.IntegerField()
    s3_e5_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s3e5comment',default=1)
    s3_e6_lc = models.IntegerField()
    s3_e6_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s3e6comment',default=1)
    ...
    s4_e1_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s4e1comment',default=1)
    ...
    s4_e2_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s4e2comment',default=1)
    ...
    s4_e3_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s4e3comment',default=1)
    ...
    s4_e4_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s4e4comment',default=1)
    ...
    s4_e5_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s4e5comment',default=1)
    ...
    s4_e6_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s4e6comment',default=1)
    ...
    s4_e7_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s4e7comment',default=1)
    ...
    s4_e8_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s4e8comment',default=1)
    ...
    s4_e9_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s4e9comment',default=1)
    ...
    s5_e1_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s5e1comment',default=1)
    ...
    s5_e2_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s5e2comment',default=1)
    ...
    s5_e3_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s5e3comment',default=1)
    ...
    s5_e4_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s5e4comment',default=1)
    ...
    s5_e5_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s5e5comment',default=1)
    ...
    s5_e6_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s5e6comment',default=1)
    ...
    s5_e7_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s5e7comment',default=1)
    ...
    s5_e8_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s5e8comment',default=1)
    ...
    s5_e9_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s5e9comment',default=1)
    ...
    s6_e1_comment = models.ForeignKey(acc.models.quantitive_comment_aed,on_delete=models.PROTECT, related_name='aed1s6e1comment',default=1)
...
class monitor_safety_1(models.Model):
    ...
    cal_dev_2_cd = models.DateField()
    cal_dev_2_xd = models.DateField()
    cal_dev3 = models.ForeignKey(acc.models.Cal_device, on_delete=models.PROTECT, related_name='msa1caldev3')
    cal_dev_3_cd = models.DateField()
    cal_dev_3_xd = models.DateField()
    ...
    s5_e1_lc = models.IntegerField()
    s5_e2_lc = models.IntegerField()
    s5_e3_lc = models.IntegerField()
    s5_e4_lc = models.IntegerField()
    s5_e5_lc = models.IntegerField()
    s5_e6_lc = models.IntegerField()
    s5_e7_lc = models.IntegerField()
    s5_e8_lc = models.IntegerField()
    s5_e9_lc = models.IntegerField()
    s5_e10_lc = models.IntegerField()
    s5_e11_lc = models.IntegerField()
    s5_e12_lc = models.IntegerField()
    s5_e13_lc = models.IntegerField()
    s5_e14_lc = models.IntegerField()
    s5_e15_lc = models.IntegerField()
...
class anesthesia_machine_1(models.Model):
    ...
    s0_e1_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine,on_delete=models.PROTECT,related_name='am1s0e1comment',default=1)
    ...
    s1_e2_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine,on_delete=models.PROTECT, related_name='am1s1e2comment',default=1)

    s2_e1_lc = models.IntegerField()
    s2_e1_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine,on_delete=models.PROTECT, related_name='am1s2e1comment',default=1)
    s2_e2_lc = models.IntegerField()
    s2_e2_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine,on_delete=models.PROTECT, related_name='am1s2e2comment',default=1)
    s2_e3_lc = models.IntegerField()
    s2_e3_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine,on_delete=models.PROTECT, related_name='am1s2e3comment',default=1)
    s2_e4_lc = models.IntegerField()
    s2_e4_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine,on_delete=models.PROTECT, related_name='am1s2e4comment',default=1)
    s2_e5_lc = models.IntegerField()
    s2_e5_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine,on_delete=models.PROTECT, related_name='am1s2e5comment',default=1)



    s3_e1_lc = models.IntegerField()
    s3_e1_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine,on_delete=models.PROTECT, related_name='am1s3e1comment',default=1)
    s3_e2_lc = models.IntegerField()
    s3_e2_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine,on_delete=models.PROTECT, related_name='am1s3e2comment',default=1)
    s3_e3_lc = models.IntegerField()
    s3_e3_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine,on_delete=models.PROTECT, related_name='am1s3e3comment',default=1)
    s3_e4_lc = models.IntegerField()
    s3_e4_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine,on_delete=models.PROTECT, related_name='am1s3e4comment',default=1)
    s3_e5_lc = models.IntegerField()
    s3_e5_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine,on_delete=models.PROTECT, related_name='am1s3e5comment',default=1)
    ...
    s5_e1_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine,on_delete=models.PROTECT, related_name='am1s5e1comment',default=2)
    ...
    s17_e03 = models.IntegerField(blank=True,null =True)
    s17_e04 = models.IntegerField(blank=True,null =True)
    s17_e01 = models.IntegerField()
    s17_e02 = models.IntegerField()
    ...
    s18_e1_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine, on_delete=models.PROTECT,
                                      related_name='am1s18e1comment', default=1)
    s18_e2_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine, on_delete=models.PROTECT,
                                       related_name='am1s18e2comment', default=1)
    s18_e3_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine, on_delete=models.PROTECT,
                                       related_name='am1s18e3comment', default=1)
    s18_e4_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine, on_delete=models.PROTECT,
                                       related_name='am1s18e4comment', default=1)
    s18_e5_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine, on_delete=models.PROTECT,
                                       related_name='am1s18e5comment', default=1)
    s18_e6_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine, on_delete=models.PROTECT,
                                       related_name='am1s18e6comment', default=1)
    s18_e7_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine, on_delete=models.PROTECT,
                                       related_name='am1s18e7comment', default=1)
    s18_e8_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine, on_delete=models.PROTECT,
                                       related_name='am1s18e8comment', default=1)
    s18_e9_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine, on_delete=models.PROTECT,
                                       related_name='am1s18e9comment', default=1)
    s18_e10_comment = models.ForeignKey(acc.models.quantitive_comment_anesthesia_machine, on_delete=models.PROTECT,
                                       related_name='am1s18e10comment', default=1)

    s19_g1_e1 = models.FloatField()
    s19_g1_e2 = models.FloatField()
    s19_g1_e3 = models.FloatField()
    s19_g1_e4 = models.FloatField()
    s19_g2_e1 = models.FloatField()
    s19_g2_e2 = models.FloatField()
    s19_g2_e3 = models.FloatField()
    s19_g2_e4 = models.FloatField()
    s19_g3_e1 = models.FloatField()
    s19_g3_e2 = models.FloatField()
    s19_g3_e3 = models.FloatField()
    s19_g3_e4 = models.FloatField()
    s19_g4_e1 = models.FloatField()
    s19_g4_e2 = models.FloatField()
    s19_g4_e3 = models.FloatField()
    s19_g4_e4 = models.FloatField()
...
class defibrilator_1(models.Model):
    ...
    s7b_e1_es = models.IntegerField(null=True, blank=True)
    s7b_e1_em = models.IntegerField(null=True, blank=True)
    s7b_e1_ec = models.IntegerField(null=True, blank=True)
    s7b_e1_v = models.IntegerField(null=True, blank=True)
    s7b_e1_comment = models.ForeignKey(acc.models.quantitive_comment_defibrilator, on_delete=models.PROTECT,
                                       related_name='df1s7be1comment',default=1)

    s7b_e2_es = models.IntegerField(null=True, blank=True)
    s7b_e2_em = models.IntegerField(null=True, blank=True)
    s7b_e2_ec = models.IntegerField(null=True, blank=True)
    s7b_e2_v = models.IntegerField(null=True, blank=True)
    s7b_e2_comment = models.ForeignKey(acc.models.quantitive_comment_defibrilator, on_delete=models.PROTECT,
                                       related_name='df1s7be2comment',default=1)
    s7b_e3_es = models.IntegerField(null=True, blank=True)
    s7b_e3_em = models.IntegerField(null=True, blank=True)
    s7b_e3_ec = models.IntegerField(null=True, blank=True)
    s7b_e3_v = models.IntegerField(null=True, blank=True)
    s7b_e3_comment = models.ForeignKey(acc.models.quantitive_comment_defibrilator, on_delete=models.PROTECT,
                                       related_name='df1s7be3comment',default=1)
...
#TODO Ecg template
    ...
    s15_e1_aplc = models.IntegerField(null=True,blank=True)
    s15_e1_noaplc = models.IntegerField(null=True,blank=True)
    ...
    s15_e2_aplc = models.IntegerField(null=True,blank=True)
    s15_e2_noaplc = models.IntegerField(null=True,blank=True)
    ...
    s16_e1_aplc = models.IntegerField(null=True,blank=True)
    s16_e1_noaplc = models.IntegerField(null=True,blank=True)
    ...
    s16_e2_aplc = models.IntegerField(null=True,blank=True)
    s16_e2_noaplc = models.IntegerField(null=True,blank=True)
...
class infusion_pump_1(models.Model):
    ...
    s0_e12_status = models.BooleanField(null=True,blank=True)
    ...
    s0_e13_status = models.BooleanField(null=True,blank=True)
    ...
    s0_e21_status = models.BooleanField(null=True,blank=True)
...
class suction_1(models.Model):
    ...
    s0_e12_status = models.BooleanField(default=False,blank=True,null=True)
    ...
    s0_e13_status = models.BooleanField(default=False,blank=True,null=True)
...
class syringe_pump_1(models.Model):
    ...
    # cd = calibration date xd = expire date
    cal_dev1 = models.ForeignKey(acc.models.Cal_device,on_delete=models.PROTECT,related_name='spmp1caldev1')
    cal_dev_1_cd = models.DateField()
    cal_dev_1_xd = models.DateField()
    cal_dev2 = models.ForeignKey(acc.models.Cal_device, on_delete=models.PROTECT, related_name='spmp1caldev2')
    cal_dev_2_cd = models.DateField()
    cal_dev_2_xd = models.DateField()
    cal_dev3 = models.ForeignKey(acc.models.Cal_device, on_delete=models.PROTECT, related_name='spmp1caldev3')
    cal_dev_3_cd = models.DateField()
    cal_dev_3_xd = models.DateField()
    cal_dev4 = models.ForeignKey(acc.models.Cal_device, on_delete=models.PROTECT, related_name='spmp1caldev4')
    cal_dev_4_cd = models.DateField()
    cal_dev_4_xd = models.DateField()

    s0_e1_status = models.BooleanField(default=False)
    s0_e1_comment = models.ForeignKey(acc.models.quantitive_comment_syringe_pump,on_delete=models.PROTECT,related_name='spmp1s0e1comment')
    s0_e2_status = models.BooleanField(default=False)
    ...
    s1_e2_comment = models.ForeignKey(acc.models.quantitive_comment_syringe_pump,on_delete=models.PROTECT, related_name='spmp1s1e2comment')

    s2_e1_lc = models.IntegerField()
    s2_e1_comment = models.ForeignKey(acc.models.quantitive_comment_syringe_pump,on_delete=models.PROTECT, related_name='spmp1s2e1comment')
    s2_e2_lc = models.IntegerField()
    s2_e2_comment = models.ForeignKey(acc.models.quantitive_comment_syringe_pump,on_delete=models.PROTECT, related_name='spmp1s2e2comment')
    s2_e3_lc = models.IntegerField()
    s2_e3_comment = models.ForeignKey(acc.models.quantitive_comment_syringe_pump,on_delete=models.PROTECT, related_name='spmp1s2e3comment')
    s2_e4_lc = models.IntegerField()
    s2_e4_comment = models.ForeignKey(acc.models.quantitive_comment_syringe_pump,on_delete=models.PROTECT, related_name='spmp1s2e4comment')
    s2_e5_lc = models.IntegerField()
    s2_e5_comment = models.ForeignKey(acc.models.quantitive_comment_syringe_pump,on_delete=models.PROTECT, related_name='spmp1s2e5comment')



    s3_e1_lc = models.IntegerField()
    s3_e1_comment = models.ForeignKey(acc.models.quantitive_comment_syringe_pump,on_delete=models.PROTECT, related_name='spmp1s3e1comment')
    s3_e2_lc = models.IntegerField()
    s3_e2_comment = models.ForeignKey(acc.models.quantitive_comment_syringe_pump,on_delete=models.PROTECT, related_name='spmp1s3e2comment')
    s3_e3_lc = models.IntegerField()
    s3_e3_comment = models.ForeignKey(acc.models.quantitive_comment_syringe_pump,on_delete=models.PROTECT, related_name='spmp1s3e3comment')
    s3_e4_lc = models.IntegerField()
    s3_e4_comment = models.ForeignKey(acc.models.quantitive_comment_syringe_pump,on_delete=models.PROTECT, related_name='spmp1s3e4comment')
    s3_e5_lc = models.IntegerField()
    s3_e5_comment = models.ForeignKey(acc.models.quantitive_comment_syringe_pump,on_delete=models.PROTECT, related_name='spmp1s3e5comment')
    ...
    s5_e1_cflc = models.IntegerField(null=True,blank=True)
    s5_e1_bflc = models.IntegerField(null=True,blank=True)
    s5_e1_comment = models.ForeignKey(acc.models.quantitive_comment_syringe_pump,on_delete=models.PROTECT, related_name='spmp1s5e1comment')
...
class electrocauter_1(models.Model):
    ...
    s0_e16_status = models.BooleanField(default=False,null=True,blank=True)
    ...
    se_e1_title = models.CharField(max_length=20,null=True,blank=True)
    se_e1_comment = models.CharField(max_length=40,null=True,blank=True)
    se_e2_title = models.CharField(max_length=20,null=True,blank=True)
    se_e2_comment = models.CharField(max_length=40,null=True,blank=True)
    def __str__(self):
        return 'Licence: ' + str(self.licence) + ' - ' + str(self.device.name)
...
class ventilator_1(models.Model):
    ...
    s0_e10_status = models.BooleanField(default=False,null=True,blank=True)
    ...
    s0_e11_status = models.BooleanField(default=False,null=True,blank=True)
    ...
    s0_e14_status = models.BooleanField(default=False,null=True,blank=True)
    ...
    s0_e15_status = models.BooleanField(default=False,null=True,blank=True)
