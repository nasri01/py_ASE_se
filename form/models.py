...
class monitor_safety_1(models.Model):
    ...
    s1_e1_res = models.IntegerField(null=True, blank=True)
    s1_e2_res = models.IntegerField(null=True, blank=True)
    s1_e3_res = models.IntegerField(null=True, blank=True)
