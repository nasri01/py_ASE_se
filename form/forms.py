...
class vant_test_Form(forms.ModelForm):
    class Meta:
        model = cant_test
        #fields = '__all__'
...
class monitor_spO2_1_Form(forms.ModelForm):
    class Meta:
        ...
        #fields = '__all__'
        exclude = ['is_done','is_recal','ref_record','record','user','date','licence','cal_dev_1_cd','cal_dev_1_xd','cal_dev_2_cd','cal_dev_2_xd','cal_dev_3_cd','cal_dev_3_xd']
...
class aed_1_Form(forms.ModelForm):
    class Meta:
        model = aed_1
        #fields = '__all__'
        exclude = ['is_done','is_recal','ref_record','record','user','date','licence','cal_dev_1_cd','cal_dev_1_xd','cal_dev_2_cd','cal_dev_2_xd']
...
class anesthesia_machine_1_Form(forms.ModelForm):
    class Meta:
        ...
        #fields = '__all__'
        exclude = ['is_done','is_recal','ref_record','record','user','date','licence','cal_dev_1_cd','cal_dev_1_xd','cal_dev_2_cd','cal_dev_2_xd','cal_dev_3_cd','cal_dev_3_xd','cal_dev_4_cd','cal_dev_4_xd']
...
class electrocauter_1_Form(forms.ModelForm):
    class Meta:
        ...
        #fields = '__all__'
        exclude = ['is_done','is_recal','ref_record','record','user','date','licence','cal_dev_1_cd','cal_dev_1_xd','cal_dev_2_cd','cal_dev_2_xd','cal_dev_3_cd','cal_dev_3_xd','cal_dev_4_cd','cal_dev_4_xd','cal_dev_5_cd','cal_dev_5_xd']
