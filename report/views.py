        ...
        for model in model_list:
            ...
            if len(modelobj) == 1:
                if(model == monitor_spo2_1):
                    ...
                    data3 = []
                    data1.append(
                        int(modelobj[0].s2_e1_pr1.split('/')[0]))  # 14
                    data1.append(
                        int(modelobj[0].s2_e1_pr2.split('/')[0]))  # 15
                    data1.append(
                        int(modelobj[0].s2_e1_pr3.split('/')[0]))  # 16
                    data1.append(
                        int(modelobj[0].s2_e2_pr1.split('/')[0]))  # 17
                    data1.append(
                        int(modelobj[0].s2_e2_pr2.split('/')[0]))  # 18
                    data1.append(
                        int(modelobj[0].s2_e2_pr3.split('/')[0]))  # 19
                    data1.append(
                        int(modelobj[0].s2_e3_pr1.split('/')[0]))  # 20
                    data1.append(
                        int(modelobj[0].s2_e3_pr2.split('/')[0]))  # 21
                    data1.append(
                        int(modelobj[0].s2_e3_pr3.split('/')[0]))  # 22
                    data1.append(
                        int(modelobj[0].s2_e4_pr1.split('/')[0]))  # 23
                    data1.append(
                        int(modelobj[0].s2_e4_pr2.split('/')[0]))  # 24
                    data1.append(
                        int(modelobj[0].s2_e4_pr3.split('/')[0]))  # 25
                    data1.append(
                        int(modelobj[0].s2_e5_pr1.split('/')[0]))  # 26
                    data1.append(
                        int(modelobj[0].s2_e5_pr2.split('/')[0]))  # 27
                    data1.append(
                        int(modelobj[0].s2_e5_pr3.split('/')[0]))  # 28
                    data1.append(
                        int(modelobj[0].s2_e6_pr1.split('/')[0]))  # 29
                    data1.append(
                        int(modelobj[0].s2_e6_pr2.split('/')[0]))  # 30
                    data1.append(
                        int(modelobj[0].s2_e6_pr3.split('/')[0]))  # 31
                    data2.append(
                        int(modelobj[0].s2_e1_pr1.split('/')[1]))  # 32
                    data2.append(
                        int(modelobj[0].s2_e1_pr2.split('/')[1]))  # 33
                    data2.append(
                        int(modelobj[0].s2_e1_pr3.split('/')[1]))  # 34
                    data2.append(
                        int(modelobj[0].s2_e2_pr1.split('/')[1]))  # 35
                    data2.append(
                        int(modelobj[0].s2_e2_pr2.split('/')[1]))  # 36
                    data2.append(
                        int(modelobj[0].s2_e2_pr3.split('/')[1]))  # 37
                    data2.append(
                        int(modelobj[0].s2_e3_pr1.split('/')[1]))  # 38
                    data2.append(
                        int(modelobj[0].s2_e3_pr2.split('/')[1]))  # 39
                    data2.append(
                        int(modelobj[0].s2_e3_pr3.split('/')[1]))  # 40
                    data2.append(
                        int(modelobj[0].s2_e4_pr1.split('/')[1]))  # 41
                    data2.append(
                        int(modelobj[0].s2_e4_pr2.split('/')[1]))  # 42
                    data2.append(
                        int(modelobj[0].s2_e4_pr3.split('/')[1]))  # 43
                    data2.append(
                        int(modelobj[0].s2_e5_pr1.split('/')[1]))  # 44
                    data2.append(
                        int(modelobj[0].s2_e5_pr2.split('/')[1]))  # 45
                    data2.append(
                        int(modelobj[0].s2_e5_pr3.split('/')[1]))  # 46
                    data2.append(
                        int(modelobj[0].s2_e6_pr1.split('/')[1]))  # 47
                    data2.append(
                        int(modelobj[0].s2_e6_pr2.split('/')[1]))  # 48
                    data2.append(
                        int(modelobj[0].s2_e6_pr3.split('/')[1]))  # 49
                    ...
                    if (abs(int(modelobj[0].s1_e6_simp) - int(modelobj[0].s1_e6_nibpp)) >= 3):  # 11
                        ...
                        data3.append(1)
                    # 12
                    if (abs(int(modelobj[0].s1_e7_simp) - int(modelobj[0].s1_e7_nibpp)) >= 3.6):
                        data3.append(0)
                    else:
                        data3.append(1)
            ...
            if len(dd) != 0:
                for obj in dd:
                    ...
                    a12 = report.objects.create(tt=ad_test_type0.objects.get(type=modellist[s]), device=obj.device,
                                                ...
                                                record=rd.objects.create(
                                                    number=obj.record.number),
                                                licence=lcc.objects.create(
                                                    number=obj.licence.number),
